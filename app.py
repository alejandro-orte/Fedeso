...
# =========================================================
# ESTILOS CSS PERSONALIZADOS Y MENÚ LATERAL IZQUIERDO
# =========================================================
st.markdown("""
    <style>
...
# =========================================================
# 2. PANTALLA INTERNA (MENÚ LATERAL IZQUIERDO Y DASHBOARD)
# =========================================================
else:
    # ---------------------------------------------------------
    ...
    with st.sidebar:
        ...
        # Botón 2: Solicitud de Crédito (Formulario externo en pestaña nueva)
        st.link_button(
